---
title: "HTB-Writeup - Access"
date: 2019-03-02
# bookComments: false
# bookSearchExclude: false
---

{{< banner "access-banner2.png" "HTB Access machine info card: Windows, Easy difficulty, 20 points" >}}
...
![Security camera snapshot of a server room labeled LON-MC6](access-port80.png)
...
Let's login and see what we find.
...
Of course I tried different versions of this. `grep passw` and others.
...
You can get the file [here](access_controll.mbox).
...
I won't give you the complete rundown today. I probably will do a separate blog for different shells in the near future.
...
# Lessons Learned
I should learn to take proper notes on my machines. I had to do the machine a second time basically. *sigh*
